...
st.set_page_config(page_title="Fastpriskalkulator", page_icon="🧮")
st.write("""### Hei 👋 Her kan du sjekke om en Fastprisavtale lønner seg for deg 💰
         """)
...
fastpris = st.number_input("Fastpris", placeholder="Fastpris (Øre/kWh)")
